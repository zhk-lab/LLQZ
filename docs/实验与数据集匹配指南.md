...
- 示例：
  - 快速冒烟（先跑 30 题）：
    - `python scripts/exp2_run_pipeline.py --model <你的模型名> --m 10 --max_items 30 --require_same_label`
  - 全量运行：
    - `python scripts/exp2_run_pipeline.py --model <你的模型名> --m 10 --require_same_label`
- 主要输出文件：
